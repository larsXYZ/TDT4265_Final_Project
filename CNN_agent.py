...
class Agent(object):
    ...
    def create_model(self):
        ...
        model.add(tf.keras.layers.Conv2D(filters=20, kernel_size=3, strides=1, activation='relu', input_shape=(self.state_size[0],self.state_size[1],self.buffer_size)))
        model.add(tf.keras.layers.Conv2D(filters=20, kernel_size=3, strides=1, activation='relu'))
        model.add(tf.keras.layers.Conv2D(filters=20, kernel_size=3, strides=1, activation='relu'))
